...
//ENCODER
bool btn_primera = false;
bool btn_segunda = false;
bool btn_tercera = false;
bool btn_cuarta = false;
...
//**************************************************************
//          FUNCIÓN ENCODER CAMBIO DE POSICIÓN MENU
//**************************************************************
...
void encoder() {
    ...
    if (tiempoInterrupcion - ultimaInterrupcion > 5) {
        if (!cuartaPantallaActive) { // Verifica si no estamos en la cuarta pantalla
            if (digitalRead(DT) == HIGH) {
                POSICION++;
                item_selected++;
                if (item_selected >= NUM_ITEMS) {
...
void cuartaPantalla() {
    cuartaPantallaActive = true; // Establece la bandera como activa
    detachInterrupt(digitalPinToInterrupt(CLK)); // Desactiva la interrupción del encoder
    ...
    // Restablece item_selected a 3
    item_selected = 3;

    // Vuelve a activar la interrupción después de un breve retraso
    delay(100);
...
//     // Asegurar que item_selected permanezca en 3
//     item_selected = 3;

//     // if (item_selected == item_selected_anterior) 
//     // {	
//     //   Serial.println(item_selected);	
//     //   item_selected = item_selected_anterior  ;
//     //   item_selected_anterior = item_selected;
//     // }
//     // item_selected = 3;
