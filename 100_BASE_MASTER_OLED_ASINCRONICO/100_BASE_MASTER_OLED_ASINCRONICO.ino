...
#define EVENT_MENU   1
#define EVENT_SERIAL_PRINT_HUMEDAD_TIERRA  2
#define EVENT_SERIAL_PRINT_HUMEDAD_AIRE  3
...
void loop() {
    ...
    case EVENT_SERIAL_PRINT_HUMEDAD_TIERRA:
      onSerialPrintCompleteTierra();
      break;


    case EVENT_SERIAL_PRINT_HUMEDAD_AIRE:
      onSerialPrintCompleteAire();
      break;
...
void sensorHumedadTierra()
{
  ...
  if (diferencia > 10)//10
  {
    ...
    //Serial.println("HUM : "+(String)porcentaje_humedad);	
    estado_actual = EVENT_SERIAL_PRINT_HUMEDAD_TIERRA; // Antes había un print
  }
}
...
void sensorHumedadAire()
{
  ...
  if (tiempo_actual - ultimo_tiempo_lectura >= intervalo_lectura) 
  {
    ...
    if (diferencia >= 1)//1 
    {
        ...
        estado_actual = EVENT_SERIAL_PRINT_HUMEDAD_AIRE; // Antes había un print
...
void alarmaRiego() 
{
 ...
 if ( fecha.hour() == hora_alarma_fin && fecha.minute() == minuto_alarma_fin  && fecha.second() == segundo_alarma_fin )
  {	
